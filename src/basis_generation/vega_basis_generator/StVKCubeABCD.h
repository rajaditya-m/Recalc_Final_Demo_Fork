...
public:
  ...
  inline virtual Mat3d A(void * elementIterator, int i, int j) { (void) elementIterator; return A_[i][j]; }
  inline virtual double B(void * elementIterator, int i, int j) { (void) elementIterator; return B_[i][j]; }
  inline virtual Vec3d C(void * elementIterator, int i, int j, int k) { (void) elementIterator; return C_[i][j][k]; }
  inline virtual double D(void * elementIterator, int i, int j, int k, int l) { (void) elementIterator; return D_[i][j][k][l]; }
