...
public:
  ...
  Tet(const char *filename, double _limit_threshold, AffineTransformer<double>* affine_transform = NULL,  bool initialize_fem_module = true,bool load_interface = false);
  virtual ~Tet();
