...
//	virtual void evalPointForceDensity( int pointId, VECTOR& q, VECTOR& gOut ) = 0;
  virtual void evalPointForceDensity( int pointId, VECTOR& q, VECTOR& gOut, int poseIdx ) = 0;

  virtual void onFinishOptimizingCubature(std::vector<int>& selectedPoints, VECTOR& weights, Real relErr);
